...
{
public:
    typedef std::function<void(const std::string& msg)> ProgressCallback;
...
public:
	...
	bool Insert(std::vector<RectSize> &rects, std::map<int, Rect>& dst, FreeRectChoiceHeuristic method);
	...
	void enableRotate(bool rotate) { rotateEnable = rotate; };
