...
{
public:
	SerializeOpBuildIn() :ISerializeOp(typeid(T)) {};
...
{
public:
	SerializeOpString() :ISerializeOp(typeid(tstring)) {};
...
{
public:
	SerializeOpBoolean() :ISerializeOp(typeid(bool)) {};
...
{
public:
	SerializeOpVec2() :ISerializeOp(typeid(CONTAINER)) {};
...
{
public:
	SerializeOpVec3() :ISerializeOp(typeid(CONTAINER)) {};
...
{
public:
	SerializeOpVec4() :ISerializeOp(typeid(CONTAINER)) {};
...
{
public:
	SerializeOpEnum() :ISerializeOp(typeid(T)) {};
...
{
public:
	SerializeOpObject() :ISerializeOp(typeid(T)) {};
