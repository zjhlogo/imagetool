...
public:
    ...
    static size_t listFilesInDirectory(StringSet& filesOut,
                                       const tstring& dir,
                                       const StringSet& includeExts = StringSet(),
                                       const StringSet& excludeExts = StringSet());
    static size_t listFilesInDirectory(StringSet& filesOut, const tstring& dir, const std::regex& rg);
...
private:
    ...
    static int enumlateFiles(StringSet& filesOut, const tstring& dir, const std::regex& rg);
