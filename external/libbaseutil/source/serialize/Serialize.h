...
public:
	...
	template <typename T> bool addFieldBuildIn(const tstring& name, const std::function<bool(const T& value)>& setter, const std::function<const T&()>& getter, const IFieldAttribute* attr = nullptr)
	{
	...
	bool addFieldBoolean(const tstring& name, const std::function<bool(bool value)>& setter, const std::function<bool()>& getter, const IFieldAttribute* attr = nullptr)
	{
	...
	template <typename T> bool addFieldEnum(const tstring& name, const std::function<bool(T value)>& setter, const std::function<T()>& getter, const IFieldAttribute* attr = nullptr)
	{
		std::type_index classId(typeid(T));
	...
	bool addFieldFlag(const tstring& name, const std::function<bool(uint value)>& setter, const std::function<bool(uint value)>& clear, const std::function<uint()>& getter, const IFieldAttribute* attr = nullptr)
	{
