...
public:
	...
	bool replaceChannel(const spank::tstring& strFile1, FREE_IMAGE_COLOR_CHANNEL eChannel1, const spank::tstring& strFile2, FREE_IMAGE_COLOR_CHANNEL eChannel2, const spank::tstring& strOutFile);
	bool binPack(const spank::StringList& files, const spank::StringList& exts, const spank::tstring& outputImageType, const spank::tstring& strOutFile, int packingFlag = 0);
	...
	bool splitByCount(const spank::StringList& files, const spank::StringList& exts, int rows, int cols, const spank::tstring& outputType, const spank::tstring& dirOut);
	bool splitBySize(const spank::StringList& files, const spank::StringList& exts, int subWidth, int subHeight, const spank::tstring& outputType, const spank::tstring& dirOut);
	bool subtract(const spank::tstring& file1, const spank::tstring& file2, const spank::tstring& strOutFile);
	bool groupByFingerPrint(const spank::StringList& files, const spank::StringList& exts, const spank::tstring& outputType, const spank::tstring& commandFormat, int distance);
	bool groupByName(const spank::StringList& files, const spank::StringList& exts, const spank::tstring& outputType, const spank::tstring& commandFormat, int distance);
...
private:
    ...
    void saveAtlasInfoXml(const spank::tstring& id, const spank::tstring& imageFile, const spank::tstring& configFile, int width, int height, const PackingUtil::PieceFileInfoMap& pieceFileInfoMap);
    void saveAtlasInfoCpp(const spank::tstring& strOutDir, const spank::tstring& className, const spank::tstring& imageType, float width, float height, const PackingUtil::PieceFileInfoMap& pieceFileInfoMap);
};
